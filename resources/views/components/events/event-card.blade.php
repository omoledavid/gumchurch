...
<div class="col-lg-6">
    <div class="thumb">
        <a href="{{route('events.show', $event->slug)}}">
            <div class="event-thumbnail" style="background: #eee url('{{ asset($event->thumbnail) }}') no-repeat center center; background-size: cover;">
            </div>

{{--            <img width="579px" height="370px" class="rounded mt-sm-0 w-100" src="{{asset($event->thumbnail)}}" alt="Blessed" data-aos="fade-up">--}}
        </a>
    </div>
    <div class="position-relative mb-5 d-flex justify-content-center event-card-1 hover-up">
        <div class="content-event rounded">
            ...
            <div class="d-flex flex-column flex-lg-row align-items-lg-center justify-content-between">
                ...
                <div class="button">
                    <a href="{{route('events.show', $event->slug)}}" class="d-inline-flex rounded-5 tc-btn-md fs-8 text-center">
