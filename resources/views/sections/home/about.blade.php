<section class="section-6 position-relative">
    <div class="container">
        <div class="row d-flex align-items-center">
            <div class="col-lg-6 pe-lg-4">
                <div class="position-relative">
                    <div class="background">
                        <img src="{{asset('gum/images/about us.png')}}" alt="Blessed" data-aos="fade-zoom-in">
                    </div>
                    <div class="card-float position-absolute br-4 alltuchtopdown">
                        <div class="card-float-top rounded-top-1">
                            <img class="mb-2" src="{{asset('assets/images/home1/book-card-sec6.png')}}" alt="Blessed"
                                 data-aos="fade-up">
            ...
            <div class="col-lg-6 d-flex align-content-start flex-wrap pt-lg-0 pt-5 ps-lg-4">
                ...
                <a href="tel:{{formatPhoneNumber($general->site_phone) ?? ''}}" class="pt-2 d-flex align-items-center" data-aos="flip-up">
    ...
    <div class="wrap-asset position-absolute">
        <img src="{{asset('assets/images/home1/img-sec-6.png')}}" alt="Blessed" data-parallax='{"x" : 100 , "y" : -200 }'>
    </div>
</section>
